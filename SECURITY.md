...
repositories, please report it to us using the [Github Private vulnerability reporting tool](https://github.com/statisticsnorway/kurs-metode-pers-utvalg/security/advisories).