...
##########################
# Antar at responssannsynligheten (rs) kun er avhengig av utdanning;
# jo høyere utdanning, desto høyere sannsynlighet for å svare
# på undersøkelsen.
...
#
svystatTM(descal, y = ~y1, by = ~kjonn * ald_grp, vartype = "se")
...
svystatL(descal, expression(y1 / y2), by = ~region, vartype = "se", conf.int = TRUE)
